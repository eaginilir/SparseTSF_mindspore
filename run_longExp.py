...
if __name__ == '__main__':
    ...
    args.use_gpu = True if context.get_context("device_target") == "GPU" and args.use_gpu else False
    ...
    context.set_context(device_target="GPU" if args.use_gpu and context.get_context("device_target") == "GPU" else "CPU")
